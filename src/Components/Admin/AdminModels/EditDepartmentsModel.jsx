...
import { UpdateDepartment } from './../../../Apis/apiHandlers';

export default function EditDepartmentsModel({ isOpen, onClose, departmentId, departmentData }) {
    ...
    useEffect(() => {
        if (departmentData) {
            setFormData({
                ...
                headName: departmentData.headName || "",
